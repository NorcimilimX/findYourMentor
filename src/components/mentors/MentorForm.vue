<template>
  <form @submit.prevent="submitForm">
    ...
    <div class="form-control">
      ...
      <div>
        <input type="checkbox" id="devops" value="devops" v-model="areas">
        <label for="devops">System Administration / Devops</label>
      </div>
      <div>
        <input type="checkbox" id="pm" value="pm" v-model="areas">
        <label for="pm">Project Management</label>
      </div>
      <div>
        <input type="checkbox" id="marketing" value="marketing" v-model="areas">
